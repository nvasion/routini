...
// Protected: integrations catalog/CRUD/test. Authentication (and CSRF for
// state-changing methods) is enforced inside the router itself, mirroring
// the credentials router above.
